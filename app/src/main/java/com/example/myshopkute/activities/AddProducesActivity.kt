...
import com.example.myshopkute.databinding.ActivityAddProducesBinding
...
class AddProducesActivity : BaseActivity(), View.OnClickListener {
    // A global variable for URI of a selected image from phone storage.
    private var mSelectedImageFileUri: Uri? = null
    private lateinit var binding: ActivityAddProducesBinding
    // A global variable for uploaded product image URL.
    private var mProductImageURL: String = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityAddProducesBinding.inflate(layoutInflater)
        setContentView(binding.root)
        setupActionBar()
        binding.ivAddUpdateProduct.setOnClickListener(this@AddProducesActivity)
        binding.btnSubmit.setOnClickListener(this@AddProducesActivity)
    }
            ...
            when (v.id) {
                ...
                binding.ivAddUpdateProduct.id-> {
                    if (ContextCompat.checkSelfPermission(
                        ...
                        Constants.showImageChooser(this@AddProducesActivity)
                    } else {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                GlideLoader(this@AddProducesActivity).loadUserPicture(
    ...
    private fun uploadProductDetails() {
        ...
        val username =
            this.getSharedPreferences(Constants.MYSHOPKUTE_PREFERRENCES, Context.MODE_PRIVATE)
                .getString(Constants.LOGGED_IN_USERNAME, "")!!

        // Here we get the text from editText and trim the space
        val produce = Produces(
        ...
        FirestoreClass().uploadProductDetails(this@AddProducesActivity, produce)
    }
